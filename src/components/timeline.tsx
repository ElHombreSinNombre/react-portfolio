...
const items = [{ text: "Work 1", description: "Test 1", date: "2022", latest: true }, { text: "Work 2", description: "Test 2", date: "2021", latest: false }, { text: "Work 3", description: "Test 3", date: "2020", latest: false }];
...
function Item(element: any) {
    ...
    return (
        <li className="mb-10 ml-6">
            ...
            <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">{element.element.text}
                {latest}
            </h3>
